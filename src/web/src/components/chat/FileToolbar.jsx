...
// with a stacked ▲▼ arrow icon. Opens a dropdown menu with two actions:
...
export function FileToolbar(props) {
  ...
  return h('div', { class: 'file-toolbar' },
    h('button', {
      ...
      h('span', { class: 'file-toolbar__arrows', 'aria-hidden': 'true' },
        h('span', { class: 'file-toolbar__arrow-up' }, '\u25B2'),
        h('span', { class: 'file-toolbar__arrow-down' }, '\u25BC')
      )
    ),
