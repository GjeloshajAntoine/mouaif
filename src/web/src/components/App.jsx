...
import { SettingsPresetsView } from './SettingsPresets.jsx';
import { SettingsAgentsView } from './SettingsAgents.jsx';
...
export function App() {
  ...
  else if (view.name === 'settingsPresets') body = h(SettingsPresetsView, { projectDir: view.projectDir });
