...
- Updated code: [src/transcribe.js](../src/transcribe.js) (the `openai-audio` family, `audioChatModel`, `audioFormatFor`, `unwrapOpenAIChatText`, the `audioTranscription` part), [src/server-handlers-transcribe.js](../src/server-handlers-transcribe.js) (both catalog slices, the cached capability report), [src/util.js](../src/util.js) (`kind` joins the project-model allow-list), [frontend/src/dictation.js](../frontend/src/dictation.js) (echoes `kind`), [frontend/src/components/DictationPage.jsx](../frontend/src/components/DictationPage.jsx), [frontend/src/components/chat/MicButton.jsx](../frontend/src/components/chat/MicButton.jsx). Tests: [scripts/test-dictation.js](../scripts/test-dictation.js), [scripts/test-dictation-http.mjs](../scripts/test-dictation-http.mjs), [scripts/test-dictation-catalog-live.mjs](../scripts/test-dictation-catalog-live.mjs), [scripts/test-dictation-ui.mjs](../scripts/test-dictation-ui.mjs). Docs: [docs/features/dictation.md](../features/dictation.md), [docs/features/openrouter.md](../features/openrouter.md).
