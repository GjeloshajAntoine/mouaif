...
- [Dictation](features/dictation.md) — speech-to-text from a page under Settings (App defaults) and from the chat composer, with a chosen model and a per-run cost.
