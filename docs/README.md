...
- [Client domains and legacy progress tool](features/notifications-progress-client-domains.md) — external-client origin/API-key configuration and compatibility behavior for `report_progress`.
