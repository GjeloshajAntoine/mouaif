...
- [Push notifications](features/push-notifications.md) — OS-level browser push notifications for chat progress, completion, and errors even when the tab is backgrounded or closed.
