...
2. **Access & Security** — configure optional password protection, passkeys, and manage sessions from **Settings → Access & passkeys** (see [Authentication](./authentication.md)).
...
- [Authentication](./authentication.md) — user login, passwords, and passkeys.
