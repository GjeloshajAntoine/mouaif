...
- `frontend/src/router.js` maps `#/settings/project/preview` to `settingsProjectPreview`; `frontend/src/components/App.jsx` routes it to `SettingsProjectView` with `page: 'preview'`.
