...
- Tap the **file-toolbar** button (the stacked arrow/folder icon) left of the textarea and pick the action by name. Action rows show only the action name, without an icon, section heading, or type metadata.
