...
- Tap the **file-toolbar** button (the stacked arrow/folder icon) left of the textarea and pick the action by name. Action rows omit redundant section and type metadata.
