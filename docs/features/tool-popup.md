...
- **Mobile (< 480 px):** the dialog stays a compact upward-opening popover instead of expanding into a full-screen sheet. Its width is capped to the viewport, its height remains limited and scrollable, and the layout-neutral wrapper avoids pointer-event coupling between sizing and interactive controls.