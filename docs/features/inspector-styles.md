...
5. **Add a property** — tap one of the quick chips (**color**, **background-color**, **font-size**, **margin**, **padding**, **border**) to open the editor. A chip whose property is already declared is shown in the accent colour and re-opens it **with its current value** (its tooltip reads `padding — set to 10px`); the others open blank. You can also type any property name in the editor's property field.
