# Restart API — implementation notes

> Agent-facing reference for [`docs/features/restart-api.md`](../../features/restart-api.md). The human-facing surface lives in that file; the implementation details, wire shapes, and source paths live here.
