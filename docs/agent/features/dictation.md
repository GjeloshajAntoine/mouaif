...
## Reference detail moved from the public page

The public page was trimmed to what a user needs. The full route selection, transcript parsing, layout, and wait-reporting detail lives here.
...
[Usage metrics](../../features/usage-metrics.md).
...
[Model bookmarks](../../features/model-bookmarks.md).
