# iOS touch scroll — the chat transcript scrolls when the user drags it — implementation notes

> Agent-facing reference for [`docs/features/ios-touch-scroll.md`](../../features/ios-touch-scroll.md). The human-facing surface lives in that file; the implementation details, wire shapes, and source paths live here.
