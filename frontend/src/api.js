...
export const SETTINGS_PROVIDERS = [
  ...
  { id: 'github-copilot',    label: 'GitHub Copilot',     defaultBaseUrl: 'https://api.githubcopilot.com',            hint: 'Sign in with a GitHub one-time code. An active Copilot plan on that GitHub account is required to chat.', reserved: true, oauth: true },
