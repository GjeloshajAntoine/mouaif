...
import { bracketMatching, foldGutter, indentOnInput, defaultHighlightStyle, syntaxHighlighting } from '@codemirror/language';
  ...
  return h('div', {
    ...
    h('div', { class: 'fe__sheet' + (editorFull ? ' fe__sheet--full' : '') },
      h('div', { class: 'fe__head' },
        ...
        h('div', { class: 'fe__crumbs', 'aria-label': 'Breadcrumb' }, renderBreadcrumb()),
        h('div', { class: 'fe__list-status' },
